...
add wave -noupdate -color White {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/pc_reg0/stall[0]}
add wave -noupdate -color White {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/pc_reg0/stall[1]}
...
add wave -noupdate -color White {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/if_id0/stall[1]}
add wave -noupdate -color White {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/if_id0/stall[2]}
...
add wave -noupdate -expand -group id -color Magenta /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/ctrl0/stallreq_from_id
add wave -noupdate -color White {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/id_ex0/stall[2]}
add wave -noupdate -color White {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/id_ex0/stall[3]}
...
add wave -noupdate -expand -group ex -color Magenta /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/ctrl0/stallreq_from_ex
add wave -noupdate -color White {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/ex_mem0/stall[3]}
add wave -noupdate -color White {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/ex_mem0/stall[4]}
...
add wave -noupdate -color White {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/mem_wb0/stall[4]}
add wave -noupdate -color White {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/mem_wb0/stall[5]}
...
add wave -noupdate -expand -group ram /openmips_min_sopc_tb/openmips_min_sopc0/data_ram0/data_o
...
add wave -noupdate -expand -group reg /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/regfile1/regs
add wave -noupdate -expand -group reg -radix hexadecimal {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/regfile1/regs[1]}
add wave -noupdate -expand -group reg {/openmips_min_sopc_tb/openmips_min_sopc0/openmips0/regfile1/regs[2]}
...
WaveRestoreCursors {{Cursor 1} {381626 ps} 0}
...
update
WaveRestoreZoom {75707 ps} {493017 ps}
