...
add wave -noupdate -expand -group mem /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/mem0/LLbit_i
add wave -noupdate -expand -group mem /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/mem0/wb_LLbit_we_i
add wave -noupdate -expand -group mem /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/mem0/wb_LLbit_value_i
add wave -noupdate -expand -group mem /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/mem0/LLbit_we_o
add wave -noupdate -expand -group mem /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/mem0/LLbit_value_o
add wave -noupdate -expand -group mem -color Yellow -label clk /openmips_min_sopc_tb/openmips_min_sopc0/clk
...
add wave -noupdate -expand -group wb /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/LLbit_reg0/we
add wave -noupdate -expand -group wb /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/LLbit_reg0/LLbit_i
add wave -noupdate -expand -group wb /openmips_min_sopc_tb/openmips_min_sopc0/openmips0/LLbit_reg0/LLbit_o
...
WaveRestoreCursors {{Cursor 1} {86970 ps} 0}
...
update
WaveRestoreZoom {0 ps} {413912 ps}
